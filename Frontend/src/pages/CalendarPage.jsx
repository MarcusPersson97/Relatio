...
const activities = [
  {
    ...
    time: "10:00",
    type: "Call",
    customer: "Norwegian Fish & Oil",
    contactPerson: "Inge Aas Eriksen",
    status: "Planned",
    notes: "Discuss difference between skrei and salmon.",
  },
  {
    id: 2,
    title: "Coffe with Teo",
    date: "2026-05-18",
    time: "14:30",
    type: "Meeting",
    customer: "Homemade Coffee",
    contactPerson: "Teo Turland",
    status: "Planned",
    notes: "Taste Teo's new special coffee.",
  },
  {
    id: 3,
    title: "Potential new client",
    date: "2026-05-22",
    time: "09:00",
    type: "potential client",
    customer: "PQ formel AB",
    contactPerson: "Marcus Persson",
    status: "Important",
    notes: "Discuss how to help PQ Formel AB.",
  },
];
